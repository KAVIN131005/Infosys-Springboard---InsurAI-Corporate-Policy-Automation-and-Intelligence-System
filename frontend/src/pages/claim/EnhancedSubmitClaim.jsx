          ...
          {claimResult.autoApproved ? (
            <>
              ...
              <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6 mb-6">
                <h2 className="text-xl font-semibold text-green-800 mb-3">💰 Payment Processing</h2>
            ...
            <>
              ...
              <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 mb-6">
                <h2 className="text-xl font-semibold text-blue-800 mb-3">📋 Under Review</h2>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {currentStep === 1 && (
            <div className="space-y-8">
              <div className="text-center">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">📋 Select Policy & Claim Type</h2>
                <p className="text-gray-600">Choose the policy and type of claim you want to submit</p>
              </div>
                  ...
                  {userPolicies.map((policy) => (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="font-semibold text-gray-900">{policy.name || `${policy.type} Insurance`}</div>
                          <div className="text-sm text-gray-600">Policy #{policy.policyNumber || policy.id}</div>
          ...
          {currentStep === 3 && (
            <div className="space-y-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">Upload any supporting documents to strengthen your claim</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-xl p-6">
                <div className="text-center">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">🤖 AI-Powered Processing</h3>
                  <p className="text-gray-600 mb-4">
                    ...
                    <div className="mb-4">
                      <div className="bg-white rounded-lg p-4 mb-2">
                        <div className="flex items-center justify-center space-x-2">
                          <Spinner size="small" />
                          <span>Processing your claim with AI...</span>
                        </div>
          ...
          <div className="flex justify-between mt-8 pt-6 border-t border-gray-200">
            <Button
              ...
              className="px-6 py-3 border border-gray-300 text-gray-700 hover:bg-gray-50 disabled:opacity-50 rounded-lg"
            >
              ← Previous
            </Button>
