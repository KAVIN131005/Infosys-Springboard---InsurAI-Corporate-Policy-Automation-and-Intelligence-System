...
INSERT INTO users (username, email, password, first_name, last_name, role_id, is_verified, is_active, created_at, updated_at) 
SELECT 'admin', 'admin@insur.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2uheWG/igi.', 'System', 'Administrator', r.id, true, true, NOW(), NOW()
FROM role r 
WHERE r.name = 'ADMIN' 
AND NOT EXISTS (SELECT 1 FROM users WHERE username = 'admin');

INSERT INTO users (username, email, password, first_name, last_name, role_id, is_verified, is_active, created_at, updated_at) 
SELECT 'broker1', 'broker1@insur.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2uheWG/igi.', 'John', 'Broker', r.id, true, true, NOW(), NOW()
FROM role r 
WHERE r.name = 'BROKER' 
AND NOT EXISTS (SELECT 1 FROM users WHERE username = 'broker1');

INSERT INTO users (username, email, password, first_name, last_name, role_id, is_verified, is_active, created_at, updated_at) 
SELECT 'broker2', 'broker2@insur.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2uheWG/igi.', 'Sarah', 'Johnson', r.id, true, true, NOW(), NOW()
FROM role r 
WHERE r.name = 'BROKER' 
AND NOT EXISTS (SELECT 1 FROM users WHERE username = 'broker2');

INSERT INTO users (username, email, password, first_name, last_name, role_id, is_verified, is_active, created_at, updated_at) 
SELECT 'user1', 'user1@email.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2uheWG/igi.', 'Alice', 'Smith', r.id, true, true, NOW(), NOW()
FROM role r 
WHERE r.name = 'USER' 
AND NOT EXISTS (SELECT 1 FROM users WHERE username = 'user1');

INSERT INTO users (username, email, password, first_name, last_name, role_id, is_verified, is_active, created_at, updated_at) 
SELECT 'user2', 'user2@email.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2uheWG/igi.', 'Bob', 'Wilson', r.id, true, true, NOW(), NOW()
FROM role r 
WHERE r.name = 'USER' 
AND NOT EXISTS (SELECT 1 FROM users WHERE username = 'user2');

INSERT INTO users (username, email, password, first_name, last_name, role_id, is_verified, is_active, created_at, updated_at) 
SELECT 'user3', 'user3@email.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2uheWG/igi.', 'Emma', 'Davis', r.id, true, true, NOW(), NOW()
FROM role r 
WHERE r.name = 'USER' 
AND NOT EXISTS (SELECT 1 FROM users WHERE username = 'user3');
...
FROM users u WHERE u.username = 'broker1'
...
FROM users u WHERE u.username = 'broker2'
